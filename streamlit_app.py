...
try:
    ...
    st.download_button('Download', calculation.discoverable_but_not_desirable_items(df, limit, result_number), 'text/csv')
    ...
    st.download_button('Download', calculation.desirable_but_not_discoverable_items(df, limit, result_number), 'text/csv')
